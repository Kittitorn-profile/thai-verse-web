...
export function HomeView() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Box sx={{ mx: 'auto', maxWidth: 1280, position: 'relative', zIndex: 2 }}>
          <Box sx={{ maxWidth: 610 }}>
            ...
            <Typography variant="h1">วัฒนธรรมไทย</Typography>

            <Typography variant="h5">
              สำรวจประเพณี อาหารพื้นถิ่น หัตถกรรม ภาษา กลุ่มชาติพันธุ์
              และมรดกวัฒนธรรมของประเทศไทยผ่านแผนที่แบบ Interactive
            </Typography>
          </Box>
      ...
      <Box sx={{ bgcolor: theme.palette.secondary.main, px: { xs: 0, md: 8, lg: 13 } }}>
        <ThailandMap />
      </Box>
